...
export async function POST(request) {
  try {
    ...
    const timezone = request.headers.get("timezone"); // ✅ 1. Extract timezone from headers
    const {
      filter,
      StartDate,
      EndDate,
    ...
    if (queryType === 0) {
      ...
      const passFailEvaluationData = data.recordsets[0];
      ...
      return NextResponse.json({
        ...
        data: {
          passFailEvaluationData: passFailEvaluationData,
