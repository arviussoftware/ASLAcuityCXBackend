...
export async function GET(request) {
  try {
    ...
    const data = await executeStoredProcedure("usp_GetAllChannelTypes");
    const channelTypes = data.recordsets[0];
    ...
    console.error("Error occurred while fetching channel types:", error);
    return NextResponse.json(
