...
export async function POST(request) {
  try {
    ...
    const params = {
      ...
      sourceAccessKey: body.sourceAccessKey || null,
      sourceSecretKey: body.sourceSecretKey || null,
      ...
      timezone:
        body.timezone && body.timezone !== "-- Select Timezone --"
          ? body.timezone
          : null,
      destDirectory: body.destDirectory || null,
      fileFormat: body.fileFormat || null,
      folderStructure: body.folderStructure || null,
      // PlatformId: parseInt(body.PlatformId) || 0,
      // OrganizationId: parseInt(body.OrgId) || 0,
      startTime: body.startTime || null,
      expiryTime: body.expiryTime || null,
      frequencyInMinutes: parseInt(body.frequencyInMinutes) || 0,
      UpdatedBy: parseInt(body.Createdby) || 0,
      Transcription: body.transcription || 0,
      transcriptionEngine: body.transcriptionEngine || null,
      sendFileChannel: channel || null,
    ...
    await logError("POST /api/workspace/updateNiceappsetting", error);
    return NextResponse.json(
