...
import { decryptEnvKey } from "./connectionCredentials.js";

const s3Config = {
  region: process.env.REGION,
};

const accessKeyId = decryptEnvKey(process.env.Amazon_ACCESS_KEY_ID);
const secretAccessKey = decryptEnvKey(process.env.Amazon_SECRET_ACCESS_KEY);
